...
{
    public partial class FrmUrunPredicate : DevExpress.XtraEditors.XtraForm
    {
        FoxSoftWareBusinessUOW _BusinesUOW;
        public FrmUrunPredicate()
        {
            InitializeComponent();
        ...
        private void BtnYeniUrunTanim_Click(object sender, EventArgs e)
        {
            ...
            FrmUrunTanim btanim2 = new FrmUrunTanim(model);
        ...
        public void FormModelGuncelle()
        {
            ...
            FrmUrunTanim btanim = new FrmUrunTanim(viewModel);
        ...
        public void Yenile()
        {
            ...
            _BusinesUOW = new FoxSoftWareBusinessUOW(DataAccessHelper.NewContext);
            gridControl1.DataSource = _BusinesUOW.UrunRepository.GetAll().Where(x=>x.StokTipi==StokTipi.Satis);
        }
        private void urunpredicate_Load(object sender, EventArgs e)
        {
            gridView1.OptionsBehavior.Editable = false;
