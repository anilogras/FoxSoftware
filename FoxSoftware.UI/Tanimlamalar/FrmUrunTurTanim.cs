...
namespace FoxSoftware.UI.Tanimlamalar
{
    public partial class FrmUrunTurTanim : DevExpress.XtraEditors.XtraForm
    {
        ...
        private UrunTur _model;
        private DbContext _context;
        public FrmUrunTurTanim(ViewFormModel<UrunTur> ViewForm)
        {
            InitializeComponent();
            _model = ViewForm.CreateModel();
            _context = ViewForm.Context;
            _BusinesUOW = new FoxSoftWareBusinessUOW(_context);
            urunTurBindingSource.DataSource = ViewForm.Model;
        }
        private void FrmUrunTurTanim_Load(object sender, EventArgs e)
        {
